...
class TabBarController:  UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad(){
        ...
        discoverViewController = DiscoverViewController(collectionViewLayout: UICollectionViewFlowLayout())
        ...
        discoverVC.tabBarItem.image = UIImage(systemName: "magnifyingglass")
        discoverVC.tabBarItem.selectedImage = UIImage(systemName: "magnifyingglass")
...
//        inboxViewController.tabBarItem.selectedImage = UIImage(systemName: "text.bubble.fill")
        ...
        viewControllers = [homeNavigationController,discoverVC, mediaViewController, profileViewController]
        
        let tabBarItemTitle = ["Home", "Discover" , "Add", "Me"]
