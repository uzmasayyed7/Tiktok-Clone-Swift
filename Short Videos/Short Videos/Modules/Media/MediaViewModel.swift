...
//  Tiktok-Clone-Swift
//
//  Created by Uzma Sayyed on 9/30/20.
...
class MediaViewModel: NSObject{
    ...
    func postVideo(videoURL: URL, caption: String, success: @escaping (String) -> Void, failure:  @escaping (Error) -> Void){
        ...
        let post = Post(id: "REMOVE", video: videoName, videoURL: videoURL, videoFileExtension: VIDEO_FILE_EXTENSION, videoHeight: 1800, videoWidth: 900, autherID: "n96kixJqddGqZpMqL8t8", autherName: "Sam", caption: caption, music: "Random Music Name", likeCount: randomNumber(min: 1000, max: 100000), shareCount: randomNumber(min: 1000, max: 100000), commentID: "random", thumbnailURL: "https://images.unsplash.com/photo-1593642634367-d91a135587b5", title: "Sample Title")
